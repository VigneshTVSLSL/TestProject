...
public class TC_Eapps_017_TRIP_SUMMARY_DETAILS extends SuperTestNGBeforeAndAfterMethod {
	@Test
	public void TRIP_SUMMARY_DETAILS() throws InterruptedException {
		...
		driver.get("http://testing.tvslsl.in/eapps/TAT/TripSummaryReport.aspx?name=M1");
