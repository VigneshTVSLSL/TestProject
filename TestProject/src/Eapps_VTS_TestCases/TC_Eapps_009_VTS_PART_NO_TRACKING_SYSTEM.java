...
public class TC_Eapps_009_VTS_PART_NO_TRACKING_SYSTEM extends SuperTestNGBeforeAndAfterMethod {
	@Test
	public void VTS_PART_NO_TRACKING_SYSTEM() throws InterruptedException {
		...
		driver.get("http://testing.tvslsl.in/eapps/VTS/vehicletrackmap2.aspx?name=M1");
