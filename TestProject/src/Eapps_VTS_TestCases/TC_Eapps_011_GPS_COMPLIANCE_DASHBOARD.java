...
public class TC_Eapps_011_GPS_COMPLIANCE_DASHBOARD extends SuperTestNGBeforeAndAfterMethod {
	@Test
	public void GPS_COMPLIANCE_DASHBOARD() throws InterruptedException {
		...
		driver.get("http://testing.tvslsl.in/eapps/VTS/GPSComplianceDashboard_New.aspx?name=M1");
