...
public class TC_Eapps_018_TVS_Vehicle_Finder extends SuperTestNGBeforeAndAfterMethod {
	@Test
	public void TVS_Vehicle_Finder() throws InterruptedException {
		...
		driver.get("http://testing.tvslsl.in/eapps/Geo/VTS_Vehicle_Search.aspx?name=M1");
