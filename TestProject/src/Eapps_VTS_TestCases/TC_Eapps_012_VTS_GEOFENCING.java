...
public class TC_Eapps_012_VTS_GEOFENCING extends SuperTestNGBeforeAndAfterMethod {
	@Test
	public void VTS_GEOFENCING() throws InterruptedException {
		...
		driver.get("http://testing.tvslsl.in/eapps/Geo/VTS_Supplier_Geofence.aspx?name=M1");
