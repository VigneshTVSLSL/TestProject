...
public class TC_Eapps_013_VECHILES_AT_FENCE_LOCATON extends SuperTestNGBeforeAndAfterMethod {
	@Test
	public void VECHILES_AT_FENCE_LOCATON() throws InterruptedException {
		...
		driver.get("http://testing.tvslsl.in/eapps/Geo/VTS_Geofence_curr_veh_Position.aspx?name=M1");
