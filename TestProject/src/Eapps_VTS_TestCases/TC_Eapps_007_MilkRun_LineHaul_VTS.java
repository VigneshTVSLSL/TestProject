...
public class TC_Eapps_007_MilkRun_LineHaul_VTS extends SuperTestNGBeforeAndAfterMethod {
  @Test
  public void MilkRun_LineHaul_VTS() throws InterruptedException 
  
  {
	...
	//finding Password field and entering Password value
	  ...
	  //finding Login Button & clicking Submit Button.
		...
		*/
		...
		//Navigating to Dock congestion dashboard page
		
		driver.get("http://testing.tvslsl.in/eapps/Geo/VehicleTrackingSystemHomePage.aspx?name=M1");
	...
	/*	//finding & Clicking VTS Map Tracking
		...
		System.out.println("TC_Eapps_007_MilkRun_LineHaul_VTS:Passed- Consolidated MilkRun_Line Haul  Dashboard is generated successfully");
