...
public class TC_Eapps_004_VTSMapTracking extends SuperTestNGBeforeAndAfterMethod {
  @SuppressWarnings("deprecation")
@Test
  public void VTSMapTracking() throws InterruptedException 
  
  {
	...
	//finding Password field and entering Password value
	  ...
	  //finding Login Button & clicking Submit Button.
		...
		*/
		...
		driver.get("http://testing.tvslsl.in/eapps/VTS/SlideProvision.aspx?name=M1");
	...
	/*	//finding & Clicking VTS Map Tracking
		...
		System.out.println("TC_Eapps_004_VTSMapTracking:Passed- VTS Map Tracking is generated successfully");
